...
- (void)viewDidLayoutSubviews {
  ...
  CGRect newMenuFrame =
      CGRectMake(0, 0, _stageBounds.size.width / 5.0, _stageBounds.size.height);
  ...
  CGRect newStageFrame = CGRectMake(
      _stageBounds.size.width / 5.0,
      _stageBounds.size.height / 2.0 - stageSize / 2.0, stageSize, stageSize);
...
- (void)viewDidLoad {
  ...
  _CGMenu = [[UITableView alloc]
      initWithFrame:CGRectMake(0, 0, VC_WIDTH / 5.0, VC_HEIGHT)
